...
local RadientPaid = RadientPaid:Window("Blox Fruit (UPDATE 17 [Racev4])")

local server = RadientPaid:Server("Domadic HUB", "", "")

local S = server:Channel("Settings")
local Main = server:Channel("Main")
local Stats = server:Channel("Stats")
local P = server:Channel("Player")
local JaiGayRay = server:Channel("Teleport")
local YedHee = server:Channel("Dungeon")
local Esus = server:Channel("DevilFruit")
local Shop = server:Channel("Shop")
local Misc = server:Channel("Miscellaneous")
...
S:Label("⚙️Setting⚙️")
S:Toggle("Auto Set Spawn Points",true,function(value)
...
S:Toggle("Bring Mob [Normal]",true,function(value)
...
S:Toggle("Bring Mob [Lag]",false,function(value)
 _G.BringExtra = value
end)
...
S:Toggle("Fast Attack",true,function(value)
 _G.FastAttack = value
end)
...
S:Toggle("Remove Attack Animation",true,function(vu)
...
S:Toggle("Auto Ken Haki",true,function(vu)
	_G.Auto_Ken = vu
end)
spawn(function()
	while wait(2) do
...
S:Toggle("Disabled Damage Text",_G.DisableDamage,function(value)
...
S:Toggle("Remove Fog",false,function(value)
         _G.Remove_Fog = value
...
S:Button("Click Tp Tool",function()
...
spawn(function()
 ...
 pcall(function()
  ...
  _G.Select_Weapon = EquipWeaponMelee()
  elseif _G.SelectWeapon == "Sword" then
  _G.Select_Weapon = EquipWeaponSword()
  elseif _G.SelectWeapon == "Fruit" then
  _G.Select_Weapon = EquipWeapon(game:GetService("Players").LocalPlayer.Data.DevilFruit.Value)
  end
  end)
 end
 end)
...
Main:Toggle("Auto Farm Melee",_G.MeleeFarm,function(vu)
	_G.MeleeFarm = vu
end)
   ...
   if _G.MeleeFarm then
				pcall(function()
					...
					if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
						StartMagnet = false
						CheckQuest()
						repeat wait() topos(CFrameQuest) until (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or not _G.MeleeFarm
						if (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 then
							wait(1.2)
							game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StartQuest",NameQuest,LevelQuest)
							wait(0.5)
...
Main:Toggle("Auto Farm Sword",_G.Farm_Sword,function(vu)
   ...
   if _G.Auto_Farm_Sword then
				pcall(function()
					...
					if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
						StartMagnet = false
						CheckQuest()
						repeat wait() topos(CFrameQuest) until (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or not _G.Auto_Farm_Sword
						if (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 then
							wait(1.2)
							game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StartQuest",NameQuest,LevelQuest)
							wait(0.5)
...
Main:Label("🌍Select Mob Farm🌍")

Main:Dropdown("Select Mob", tableMon, function(vu)
 SelectMonster = vu
 end)

Main:Toggle("Farm Select Mob",_G.AutoFarmSelectMonster,function(vu)
...
Main:Toggle("Auto Farm Observation Haki + hop",_G.AutoFarmKenHaki,function(x)
				...
				pcall(function()
					if World3 then
						if game.Workspace.Enemies:FindFirstChild("Marine Commodore [Lv. 1700]") then
							if game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
								repeat wait()
									topos(game.Workspace.Enemies:FindFirstChild("Marine Commodore [Lv. 1700]").HumanoidRootPart.CFrame * CFrame.new(3,0,0))
								until _G.AutoFarmKenHaki == false or not game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
							else
								repeat wait()
									topos(game.Workspace.Enemies:FindFirstChild("Marine Commodore [Lv. 1700]").HumanoidRootPart.CFrame * CFrame.new(10,35,0))
					...
					if World2 then
						if game.Workspace.Enemies:FindFirstChild("Ship Engineer [Lv. 1275]") then
							if game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
								repeat wait()
									topos(game.Workspace.Enemies:FindFirstChild("Ship Engineer [Lv. 1275]").HumanoidRootPart.CFrame * CFrame.new(3,0,0))
								until _G.AutoFarmKenHaki == false or not game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
							else
								repeat wait()
									topos(game.Workspace.Enemies:FindFirstChild("Ship Engineer [Lv. 1275]").HumanoidRootPart.CFrame * CFrame.new(10,15,0))
									if _G.HopFunction then
										local ts = game:GetService("TeleportService")
										local p = game:GetService("Players").LocalPlayer
										ts:Teleport(game.PlaceId, p)
							...
							topos(CFrame.new(918.558777, 40.0827065, 32766.498))
						end
					end
					if World1 then
						if game.Workspace.Enemies:FindFirstChild("Galley Captain [Lv. 650]") then
							if game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
								repeat wait()
									topos(game.Workspace.Enemies:FindFirstChild("Galley Captain [Lv. 650]").HumanoidRootPart.CFrame * CFrame.new(3,0,0))
								until _G.AutoFarmKenHaki == false or not game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
							else
								repeat wait()
									topos(game.Workspace.Enemies:FindFirstChild("Galley Captain [Lv. 650]").HumanoidRootPart.CFrame * CFrame.new(10,15,0))
									if _G.HopFunction then
										local ts = game:GetService("TeleportService")
										local p = game:GetService("Players").LocalPlayer
										ts:Teleport(game.PlaceId, p)
...
Main:Label("⚔️Item & Quest⚔️")
 
 if World3 then

local Total_Elite_Hunter = Main:Label("")
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") then
					Elite_Hunter_Status:Refresh("Status : Elite Spawn!")	
				else
					Elite_Hunter_Status:Refresh("Status : Elite Not Spawn")	
				end
			end)
		end
	end)
...
StopTween(_G.Auto_Elite_Hunter)
 ...
 _G.Auto_Elite_Hunter = value
	...
	Main:Label("🦸Dough Boss🦸")

local Mob_Kill_Cake_Prince = Main:Label("")
...
Main:Toggle("Auto Cake Prince",_G.Auto_Cake_Prince,function(value)
...
StopTween(_G.Auto_Cake_Prince)
	...
	Main:Toggle("Auto Open Dough Dungeon",_G.Auto_Open_Dough_Dungeon,function(value)
...
Main:Toggle("Auto Soul Guitar + Hop",false,function(value)
  _G.soulGuitarhop = value    
 end)

Main:Label("😹Dual Curse Katana😹")

Main:Toggle("Auto Dual Curse Katana (Not Working)",_G.AutoCdk,function(value)
 _G.AutoCdk = value
end)
...
Main:Toggle("Auto Buy Law Chip",_G.Auto_Buy_Law_Chip,function(value)
...
Main:Toggle("Auto Start Law Dungeon",_G.Auto_Start_Law_Dungeon,function(value)
...
Main:Toggle("Auto Kill Law",_G.Auto_Kill_Law,function(value)
...
Main:Toggle("Auto Saber",_G.Auto_Saber,function(value)
 _G.Auto_Saber = value
 StopTween(_G.Auto_Saber)
end)

	
	Main:Toggle("Auto Saber Hop",_G.Auto_Saber_Hop,function(value)
 _G.Auto_Saber_Hop = value
	...
	Main:Toggle("Auto Pole V1",_G.Auto_Pole_Hop,function(value)
 _G.Auto_Pole = value
...
Main:Toggle("Auto Factory Farm",_G.Auto_Factory_Farm,function(value)
...
elseif World3 then
	...
	Main:Label("🦁Soul Reaper🦁")

Main:Toggle("Auto Soul Reaper",_G.Auto_Soul_Reaper,function(value)
 _G.Auto_Soul_Reaper = value
StopTween(_G.Auto_Soul_Reaper)
end)


Main:Toggle("Auto Soul Reaper Hop",_G.Auto_Soul_Reaper_Hop,function(value)
...
StopTween(_G.Auto_Soul_Reaper_Hop)
	...
	Main:Toggle("Auto Yama",_G.Auto_Yama,function(value)
	 _G.Auto_Yama = value
...
StopTween(_G.Auto_Rainbow_Haki)
	...
	Main:Toggle("Auto Rainbow Haki Hop",_G.Auto_Rainbow_Haki_Hop,function(value)
...
StopTween(_G.Auto_Rainbow_Haki_Hop)
	...
	spawn(function()
		...
		Main:Label("☄️Canvander☄️")

	Main:Toggle("Auto Canvander",_G.Auto_Canvander,function(value)
 _G.Auto_Canvander = value
StopTween(_G.Auto_Canvander)
end)

	
	Main:Toggle("Auto Canvander Hop",_G.Auto_Canvander_Hop,function(value)
...
Main:Toggle("Auto Observation Haki V2",_G.AutoObservationHakiV2,function(x)
...
StopTween(_G.Auto_Evo_Race_V2)
	...
	spawn(function()
		...
		Main:Toggle("Auto Buy Legendary Sword",_G.BuySword,function(Value)
			_G.BuySword = Value
		end)
		spawn(function()
		...
		Main:Toggle("Auto Buy Legendary Sword+Hop",_G.AutoBuySwordHop,function(Value)
...
Main:Toggle("Auto Musketeer Hat",_G.Auto_Musketeer_Hat,function(value)
...
StopTween(_G.Auto_Musketeer_Hat)
	...
	Main:Label("💪FightingStyle💪")
	
Main:Toggle("Auto Superhuman",_G.Auto_Superhuman,function(value)
 _G.Auto_Superhuman = value
end)


Main:Toggle("Auto Fully Superhuman",_G.Auto_Fully_Superhuman,function(value)
...
Main:Toggle("Auto Death Step",_G.Auto_Death_Step,function(value)
...
Main:Toggle("Auto Fully Death Step",_G.Auto_Fully_Death_Step,function(value)
...
Main:Toggle("Auto Sharkman Karate",_G.Auto_SharkMan_Karate,function(value)
...
Main:Toggle("Auto Fully Sharkman Karate",_G.Auto_Fully_SharkMan_Karate,function(value)
...
JaiGayRay:Label("🌏WORLD🌏")
 
 JaiGayRay:Button("Teleport To Old World",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
  end)
 
 JaiGayRay:Button("Teleport To Second Sea",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
 end)

 
 JaiGayRay:Button("Teleport To Third Sea",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
  end)
 
 
 JaiGayRay:Label("🏞️Island🏞️")
 
 if World1 then
 JaiGayRay:Dropdown("Select Island", {
  "WindMill",
  "Marine",
  "Middle Town",
  "Jungle",
 ...
 JaiGayRay:Toggle("Teleport",false,function(value)
  ...
  elseif _G.SelectIsland == "Cocoa Island(New)" then
  topos(CFrame.new(87.94276428222656, 73.55451202392578, -12319.46484375))
  elseif _G.SelectIsland == "Candy V2 Island(New)" then
...
YedHee:Label("Use in Dungeon Only!")
...
YedHee:Dropdown("Select Dungeon",chip,function(value)
 _G.Select_Dungeon = value
end)

YedHee:Toggle("Auto Buy Chip Dungeon",_G.Auto_Buy_Chips_Dungeon,function(value)
...
YedHee:Toggle("Auto Start Dungeon",_G.Auto_StartRaid,function(value)
...
YedHee:Toggle("Auto Next Island",_G.Auto_Next_Island,function(value)
...
YedHee:Toggle("Kill Aura",_G.Kill_Aura,function(value)
 _G.Kill_Aura = value  
end)
...
YedHee:Toggle("Auto Awake",_G.Auto_Awake,function(value)
 _G.Auto_Awake = value 
end)
...
spawn(function()
  ...
  YedHee:Button("Next Island",function()
   pcall(function()
    if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
...
function TP(Pos)
 ...
 _G.SelectFruit = ""
 Esus:Dropdown("Select Fruits Sniper",FruitList,function(value)
  _G.SelectFruit = value
  end)
 
 Esus:Toggle("Auto Buy Fruit Sniper",_G.AutoBuyFruitSniper,function(value)
  _G.AutoBuyFruitSniper = value
  end)
 
 Esus:Label("🌀Others🌀")
 
 Esus:Dropdown("Select Fruits Eat",FruitList,function(value)
  _G.SelectFruitEat = value
  end)
 
 Esus:Toggle("Auto Eat Fruit",_G.AutoEatFruit,function(value)
 ...
 Esus:Toggle("Auto Eat Fruit Hop",_G.AutoEatFruitHop,function(value)
 ...
 Esus:Toggle("Auto Random Fruit",_G.Random_Auto,function(value)
 ...
 Esus:Button("Random Fruit",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
  end)
 
 
 Esus:Toggle("Auto Drop Fruit",_G.DropFruit,function(value)
  _G.DropFruit = value
  end)
 ...
 Esus:Toggle("Auto Store Fruit",_G.AutoStoreFruit,function(value)
 ...
 Esus:Toggle("Grab Fruit",_G.BringFruit,function(value)
  _G.BringFruit = value
  pcall(function()
 ...
 Esus:Toggle("Teleport To Spawn Fruit",false,function(value)
 _G.Grabfruit = value
end)
...
spawn(function()
 ...
 Esus:Toggle("Bring All Fruit 75% Kick System",_G.BringFruitBF,function(value)
...
if World2 then
		Esus:Button("TP Flower Red",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
				if v.Name == "Flower2" then
				    topos(v.CFrame)
				end
		...
		Esus:Button("TP Flower Blue",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
				if v.Name == "Flower1" then
					topos(v.CFrame)
				end
	...
	Esus:Toggle("ESP Player",false,function(a)
		ESPPlayer = a
		while ESPPlayer do wait()
			UpdatePlayerChams()
		end
	end)
	Esus:Toggle("ESP Chest",false,function(a)
		ChestESP = a
		while ChestESP do wait()
			UpdateChestChams() 
		end
	end)
	Esus:Toggle("ESP Devil Fruit",false,function(a)
		DevilFruitESP = a
		while DevilFruitESP do wait()
			UpdateDevilChams() 
		end
	end)
	Esus:Toggle("ESP Flower",false,function(a)
		FlowerESP = a
